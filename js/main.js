...
//       infoDiv.style.left = `${tooltipLeft + 90}px`;
//       infoDiv.style.top = `${tooltipTop - 50}px`;
//     }
//     if (window.innerWidth < 1200) {
//       infoDiv.style.position = "absolute";
//       infoDiv.style.left = `${elementCenterX - infoDivRect.width / 2}px`;
//       infoDiv.style.top = `${elementCenterY - 70}px`;
//     }
